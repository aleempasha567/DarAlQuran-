<div class="row">
            <div class="main-content">
                <div>
                    ...
                    <div class="col-md-4 col-xs-9 searchbar">
                ...
                <div class="content">
                    <h2 class="sub_heading">رحلة عبر القرآن</h2>
                ...
                <div class="outer-content">
                    ...
                    <h2>من نحن </h2>
                    <p>
                        قوم آلوا على أنفسهم إحياء من اندرس من دينهم وسنن نبيهم
                        سالكين في سبيل ذلك الحكمة والموعظة الحسنة, مبشرين غير
                        منفرين, جامعين غير مشتتين, ميسرين غير معسرين .. نخالط الناس ونصبر
                        على أذاهم , نأخذ بيدهم إلى رضا الله عز وجل لا نبتغي على ذلك جزاء
                        ولا شكورا. نقرب الإسلام في بهائه ونقائه خالصاً من الشوائب
                        والزوائد لا نعبد إلا الله وحده لا شريك له, ونعبده بما شرع لا نزيد ولا
                        ننقص. ننقل الناس من عبادة العباد والشهوات إلى عبادة من خلق
                        الأرض والسماوات سبحانه. منهاجنا كتاب ربنا وسنة نبينا لا نرضى
                        بغيرهما بديلا. قال الله تعالي : (قل هذه سبيلي أدعو إلى الله على
            ...
            <div class="col-md-6 col-lg-6 col-md-10 col-md-offset-2 col-lg-offset-2 col-sm-offset-1">
                <div class="middle-block">
                    <h2>خدماتنا  ومنتجاتنا</h2>
                    <p>
                        نحن نحافظ على التطوير والإبتكار, ونقدم مجموعة واسعة من المنتجات والخدمات التي تساعد موقعنا
                        المسلمين والموقع الالكتروني على تحقيق طموحاتهم. يؤدي نشر القرآن والسنة في كل من الكلمة والفعل
                        ممكن يجعل علومهم أقر, تخدمها بكل الطرق , ثقافياً واجتماعياً وسخاء
                    </p>
                </div>
            </div>
        </div>
...
<div class="prayer-timings-section">
    <div class="col-sm-6 col-md-6 col-lg-6 prayer-bg">
        <div class="prayer-image-section"> <img src="<?php echo base_url('assets/images/paryer-image.png');?>" class="img-responsive" /> </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 p-5">
        <h1 class="prayer-timings-heading pull-right">أوقات الصلاة</h1>
        <div class="remaining-time col-xs-12">
            <div class="text-center time-circle">
                <p class="circle" id="timeLeftHours">0 <span>h</span></p>
            </div>
            <div class="text-center time-circle">
                <p class="circle text-center" id="timeLeftMinutes">0<span>m</span></p>
            </div>
            <div class="text-center time-circle">
                <p class="circle" id="timeLeftSeconds">0 <span>s</span></p>
            </div>
        </div>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <!-- Wrapper for slides -->
            <div class="carousel-inner col-md-4 text-center" id="prayerTimings">
...
<div class="quran-volume">
    <div class="col-md-6 col-lg-6 col-sm-6">
        ...
        <div class="listen_icon col-md-3 col-lg-3 col-sm-3 col-xs-3"> <img src="<?php echo base_url('assets/images/listen_icon.png'); ?>" class="img-responsive" /> </div>
